...
pygame.mixer.init() # initiating mmixer - used to add music file
alarm_sound = pygame.mixer.Sound('r1.mp3')
...
def send_email(driver_name):
    sender_email = "drowsinesshb@gmail.com"
    sender_password = "fbdg zazh umoy xdrf"
    recipient_email = "trishasrivastava002@gmail.com"
    ...
    body = f"Driver {driver_name} is feeling sleepy. Please take action."
...
class DrowsinessApp(QWidget):
    ...
    def initUI(self):
        ...
        self.name_label = QLabel("Enter the Driver's Name:")
        self.name_input = QLineEdit()

        self.number_label = QLabel("Enter the Driver's Phone Number:")
        self.number_input = QLineEdit()

        self.car_number_label = QLabel("Enter the License Plate Number:")
        ...
        l.addWidget(self.number_label)
        l.addWidget(self.number_input)
        l.addWidget(self.car_number_label)
        l.addWidget(self.car_number_input)
    ...
    def start_d(self):
        ...
        driver_number = self.number_input.text()
        driver_car_number = self.number_input.text()

        if not driver_name:
            QMessageBox.warning(self, "Warning", "Please enter the driver's name.")
            return
        if not driver_number:
            QMessageBox.warning(self, "Warning", "Please enter the driver's phone number.")
            return
        if not driver_car_number:
            QMessageBox.warning(self, "Warning", "Please enter the License Plate number.")
            return
